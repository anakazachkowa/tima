...
public class calculator {
  ...
  public static String parse(String expression) throws Exception {
      ...
      if (isRoman) {
          ...
          if (arabian <= 0) {
              throw new Exception("Римское число должн быть больше нуля");
          }
          //конвертируем результата операции из арабского в римское
      ...
      class Roman {
          static String[] romanArray = new String[]{"0", "I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX",
                  ...
                  "XXIV", "XXV", "XXVI", "XXVII", "XXVIII", "XXX", "XXXII", "XXXV", "XXXVI", "XL", "XLII", "XLV", "XLVIII",
                  "XLIX", "L", "LIV", "LVI", "LX", "LXIII", "LXIV", "LXX", "LXXII", "LXXX", "LXXXI", "XC", "C"};
